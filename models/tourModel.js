...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      type: Number,
      default: 4.5,
      min: [1, "Rating must be above 1.0 or equal"],
      max: [5, "Rating must be below 5.0 or equal"],
...
// DOCUMENT MIDDLEWARE: runs before .save() and .create() ; "this" points to the document
